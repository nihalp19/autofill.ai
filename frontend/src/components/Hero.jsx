            ...
            >
              <div className="relative w-full max-w-2xl mx-auto">
                ...
                >
                  ...
                  />
                  <button className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white px-6 py-4 rounded-r-xl flex items-center justify-center transition-all hover:from-blue-700 hover:to-indigo-800 min-w-[140px]" onClick={handleAutoFill}>
